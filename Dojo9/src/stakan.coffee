...
exports.moveDown = (sprite, count = 1) ->
  ...
  {leftX: sprite.leftX, rightX: sprite.rightX, bottomY: if newBottomY < 0 then 0 else newBottomY}
...
exports.moveRight = (stakan, sprite, count = 1) ->
  ...
  {leftX: sprite.leftX + delta, rightX:  sprite.rightX + delta, bottomY: sprite.bottomY}
